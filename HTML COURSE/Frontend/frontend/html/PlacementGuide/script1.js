...
// Course Data for Detail Pages
const courseData = {
    "HTML & CSS Fundamentals": {
        icon: "fab fa-html5",
        icon2: "fab fa-css3-alt",
        category: "Frontend Development",
        description: "Learn the basics of web development with HTML5 and CSS3",
        duration: "4 weeks",
        level: "Beginner",
        students: "2,500",
        lectures: [
            { title: "Introduction to HTML", description: "Understanding HTML structure and basic elements", duration: "45 min", completed: true, locked: false },
            { title: "HTML Forms and Inputs", description: "Creating interactive forms with various input types", duration: "50 min", completed: true, locked: false },
            { title: "CSS Fundamentals", description: "Styling web pages with CSS selectors and properties", duration: "60 min", completed: false, locked: false },
            { title: "CSS Layouts", description: "Flexbox and Grid layouts for responsive design", duration: "70 min", completed: false, locked: true },
            { title: "Responsive Design", description: "Making websites work on all devices", duration: "55 min", completed: false, locked: true },
            { title: "CSS Animations", description: "Creating smooth animations and transitions", duration: "65 min", completed: false, locked: true }
        ],
        notes: [
            { title: "HTML Cheat Sheet", type: "PDF", description: "Quick reference for HTML tags and attributes" },
            { title: "CSS Properties Guide", type: "PDF", description: "Complete guide to CSS properties and values" },
            { title: "Responsive Design Patterns", type: "PDF", description: "Common responsive design techniques" }
        ],
        practice: [
            { title: "Build Your First Website", type: "Project", description: "Create a personal portfolio website", difficulty: "easy", time: "2 hours", completed: false },
            { title: "HTML Forms Quiz", type: "Quiz", description: "Test your knowledge of HTML form elements", difficulty: "medium", time: "15 min", completed: true },
            { title: "CSS Layout Challenge", type: "Exercise", description: "Practice CSS Grid and Flexbox", difficulty: "hard", time: "1 hour", completed: false }
        ]
    },
    "JavaScript Mastery": {
        icon: "fab fa-js-square",
        category: "Frontend Development",
        description: "Complete JavaScript programming course with ES6+ features",
        duration: "6 weeks",
        level: "Intermediate",
        students: "3,200",
        lectures: [
            { title: "JavaScript Basics", description: "Variables, functions, and basic syntax", duration: "60 min", completed: true, locked: false },
            { title: "DOM Manipulation", description: "Interacting with HTML elements using JavaScript", duration: "70 min", completed: true, locked: false },
            { title: "Event Handling", description: "Managing user interactions and events", duration: "55 min", completed: false, locked: false },
            { title: "ES6+ Features", description: "Arrow functions, destructuring, and modules", duration: "80 min", completed: false, locked: true },
            { title: "Async JavaScript", description: "Promises, async/await, and AJAX", duration: "75 min", completed: false, locked: true },
            { title: "Advanced Concepts", description: "Closures, prototypes, and design patterns", duration: "90 min", completed: false, locked: true }
        ],
        notes: [
            { title: "JavaScript ES6+ Guide", type: "PDF", description: "Modern JavaScript features and syntax" },
            { title: "DOM API Reference", type: "PDF", description: "Complete DOM manipulation guide" },
            { title: "Async Programming Patterns", type: "PDF", description: "Working with asynchronous JavaScript" }
        ],
        practice: [
            { title: "Interactive Web App", type: "Project", description: "Build a dynamic web application", difficulty: "medium", time: "4 hours", completed: false },
            { title: "JavaScript Fundamentals Quiz", type: "Quiz", description: "Test your JavaScript knowledge", difficulty: "medium", time: "20 min", completed: true },
            { title: "DOM Manipulation Exercise", type: "Exercise", description: "Practice DOM interactions", difficulty: "easy", time: "1.5 hours", completed: false }
        ]
    },
    "React.js Development": {
        ...
        students: "1,250",
        lectures: [
            { title: "React Introduction", description: "Understanding React components and JSX", duration: "60 min", completed: true, locked: false },
            { title: "State and Props", description: "Managing component state and passing data", duration: "70 min", completed: true, locked: false },
            { title: "React Hooks", description: "useState, useEffect, and custom hooks", duration: "80 min", completed: false, locked: false },
            { title: "Event Handling", description: "Handling user interactions in React", duration: "50 min", completed: false, locked: true },
            { title: "Component Lifecycle", description: "Understanding component mounting and unmounting", duration: "65 min", completed: false, locked: true },
            { title: "State Management", description: "Redux and Context API for complex state", duration: "90 min", completed: false, locked: true }
        ],
        notes: [
            { title: "React Hooks Reference", type: "PDF", description: "Complete guide to React hooks" },
            { title: "JSX Best Practices", type: "PDF", description: "Writing clean and efficient JSX" },
            { title: "React Performance Tips", type: "PDF", description: "Optimizing React applications" }
        ],
        practice: [
            { title: "Todo App with Hooks", type: "Project", description: "Build a todo application using React hooks", difficulty: "medium", time: "3 hours", completed: false },
            { title: "React Concepts Quiz", type: "Quiz", description: "Test your React fundamentals", difficulty: "medium", time: "20 min", completed: true },
            { title: "Component Design Challenge", type: "Exercise", description: "Design reusable React components", difficulty: "hard", time: "2 hours", completed: false }
        ]
    }
};
